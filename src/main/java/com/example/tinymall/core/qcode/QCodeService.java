package com.example.tinymall.core.qcode;
...
public class QCodeService {
    ...
    public String createGrouponShareImage(String goodName, String goodPicUrl, TinymallGroupon groupon) {
        try {
            //创建该商品的二维码
