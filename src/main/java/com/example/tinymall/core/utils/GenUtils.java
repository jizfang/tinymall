...
import com.example.tinymall.entity.table.ColumnEntity;
import com.example.tinymall.entity.table.TableEntity;
...
public class GenUtils {
    public static List<String> getTemplates(){
        ...
        templates.add("templates/frontend/index.vue.vm");
        templates.add("templates/frontend/index.js.vm");
        return templates;
    }
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "org.fang.backend" : mainPath;
        //封装模板数据
        ...
        map.put("datetime", DateTimeUtil.format(new Date(), DateTimeUtil.DATE_TIME_PATTERN));
