...
--
-- Table structure for table `tinymall_aftersale`
--

DROP TABLE IF EXISTS `tinymall_aftersale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_aftersale` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `handle_time` bigint(20) DEFAULT NULL COMMENT '管理员操作时间',
  `create_time` bigint(20) DEFAULT NULL COMMENT '添加时间',
  `update_time` bigint(20) DEFAULT NULL COMMENT '更新时间',
  `deleted` tinyint(1) DEFAULT '0' COMMENT '售后编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='售后表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tinymall_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `parent_id` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='类目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tinymall_coupon`
--

DROP TABLE IF EXISTS `tinymall_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='优惠券信息及规则表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tinymall_coupon_user`
--

DROP TABLE IF EXISTS `tinymall_coupon_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='优惠券用户使用表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tinymall_feedback`
--

DROP TABLE IF EXISTS `tinymall_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `tinymall_goods_product`
--

DROP TABLE IF EXISTS `tinymall_goods_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_goods_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `tinymall_groupon`
--

DROP TABLE IF EXISTS `tinymall_groupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_groupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联tinymall_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `tinymall_groupon_rules`
--

DROP TABLE IF EXISTS `tinymall_groupon_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_groupon_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `goods_id` (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='团购规则表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tinymall_keyword` (
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='关键字表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tinymall_log`
--

DROP TABLE IF EXISTS `tinymall_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tinymall_notice`
--

DROP TABLE IF EXISTS `tinymall_notice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tinymall_notice_admin`
--

DROP TABLE IF EXISTS `tinymall_notice_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_notice_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='通知管理员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tinymall_permission`
--

DROP TABLE IF EXISTS `tinymall_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tinymall_role`
--

DROP TABLE IF EXISTS `tinymall_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tinymall_system`
--

DROP TABLE IF EXISTS `tinymall_system`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tinymall_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
